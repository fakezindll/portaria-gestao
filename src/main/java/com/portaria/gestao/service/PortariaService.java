...
public class PortariaService {
    ...
    public RegistroPortariaResponse registrarEntrada(String documento) {
        ...
        if (registroAtivo != null) {
            ...
            throw new ResponseStatusException(HttpStatus.CONFLICT, "Entrada já registrada e ativa.");
        }
    ...
    public RegistroPortariaResponse registrarSaida(String documento) {
        ...
        if (registroAtivo == null) {
            throw new ResponseStatusException(HttpStatus.NOT_ACCEPTABLE, "Não há entrada ativa para este funcionário.");
        }
